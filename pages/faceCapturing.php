...
if (isset($_POST["faceInput"])) {
    ...
    header('location: dataConfirmation.php');
    // echo '<script>
        ...
        <div class="center">
            ...
            <script>
                ...
                let scanner = new Instascan.Scanner({
                    video: document.getElementById('Data_preview')
                });
            ...
            <button id="capture" onclick="capturePhoto()"><i class="fa-solid fa-camera"></i> Capture</button>
            ...
            <script>
                ...
                function capturePhoto() {
                    ...
                    $.ajax({
                        ...
                        url: "verify.php",
                        data: {
                            uid: jsonData.images.at(0).transaction.subject_id
                        },
                        success: function(data) {
                            if (data) {
                                console.log('pass true');
